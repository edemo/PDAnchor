...
class CryproServerTest(unittest.TestCase):
    ...
    def test_runCommand_logs_stderr(self):
        ...
        print self.fixture.syslog.logged
        self.assertEqual(
            self.fixture.syslog.logged[0],
                '')
        self.assertTrue(
    ...
    def test_handle_logs_it_all(self):
        ...
        self.assertEqual('',self.fixture.syslog.logged[1])
        self.assertEqual('Using slot 0 with a present token (0x0)\n',self.fixture.syslog.logged[2])
        ...
        self.assertEqual('Using signature algorithm SHA512-RSA-PKCS\n',self.fixture.syslog.logged[4])
